...
while True:
    ...
    r_data = port.readline(5)
    sleep(0.3)
    data_left = port.inWaiting()
    r_data += port.readline(data_left)
    print(r_data)
    
    print("Press 1 to expand or retract")
    print("Press 2 to lock or unlock your device")
    print("or Press # to use barcode scanner")
    ...
    if (function == "#"):
        ...
        # close door
            ...
            count += 1
            if ((count > 10)):
                print("You have entered the code incorrectly too many times\n ")
                print("and are momentarily locked out")
                sleep(1000)
                count = 0
